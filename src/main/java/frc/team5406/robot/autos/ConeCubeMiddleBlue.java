...
public final class ConeCubeMiddleBlue
{

  /**
   * April Tag field layout.
   */
  private ConeCubeMiddleBlue()
  {
  ...
  public static CommandBase auto(SwerveSubsystem swerve, ShoulderSubsystem shoulder, ExtendSubsystem extend, WristSubsystem wrist, IntakeSubsystem intake, LimelightSubsystem limelight)
  {
    ...
    PathPlannerTrajectory driveToGrid;
      ...
      driveToCube = PathPlanner.generatePath(
          ...
          new PathPoint(new Translation2d(-4.7, multiplier*-0.5), Rotation2d.fromDegrees(180), Rotation2d.fromDegrees(multiplier*180))
      );
      driveToGrid = PathPlanner.generatePath(
        new PathConstraints(Constants.MAX_SPEED_METERS_PER_SECOND, Constants.MAX_ACCELERATION_METERS_PER_SECOND_SQUARED),
        new PathPoint(new Translation2d(-4.7, multiplier*-0.5), Rotation2d.fromDegrees(0), Rotation2d.fromDegrees(multiplier*-180)),
        new PathPoint(new Translation2d(-2.5, multiplier*-0.2), Rotation2d.fromDegrees(0), Rotation2d.fromDegrees(multiplier*0)),
        new PathPoint(new Translation2d(-0.2, multiplier*-0.9), Rotation2d.fromDegrees(0), Rotation2d.fromDegrees(multiplier*0)),
