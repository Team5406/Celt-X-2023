...
public final class ConeCubeEdgeRed
{

  /**
   * April Tag field layout.
   */
  private ConeCubeEdgeRed()
  {
...
PathPlannerTrajectory traj = PathPlanner.generatePath(
 ...
 PathPlannerTrajectory driveToGrid = PathPlanner.generatePath(
  ...
  true,
  new PathPoint(swerve.getPose().getTranslation(),swerve.getHeading(), swerve.getPose().getRotation()),
  new PathPoint(new Translation2d(-3, multiplier*0.3), Rotation2d.fromDegrees(0), Rotation2d.fromDegrees(multiplier*5)),
  new PathPoint(new Translation2d(-0.15,multiplier* .90), Rotation2d.fromDegrees(0), Rotation2d.fromDegrees(multiplier*0)),
  new PathPoint(new Translation2d(0.15,multiplier* .90), Rotation2d.fromDegrees(0), Rotation2d.fromDegrees(multiplier*0))
);
