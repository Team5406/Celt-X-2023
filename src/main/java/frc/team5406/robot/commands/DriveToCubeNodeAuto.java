 ...
 */
public class DriveToCubeNodeAuto extends CommandBase
{
   ...
   */
  public DriveToCubeNodeAuto(SwerveSubsystem drive, LimelightSubsystem limelight)
  {
    this.drive = drive;
  ...
  public void initialize(){
    ...
    forwardsController.setSetpoint(-6.5);
  ...
  @Override
  public void execute(){
    double fwd = MathUtil.clamp(-forwardsController.calculate(limelight.getLLty()), -3, 3);
    double side = MathUtil.clamp(sidewaysController.calculate(limelight.getUncorrectedLLtx()), -1, 1);
