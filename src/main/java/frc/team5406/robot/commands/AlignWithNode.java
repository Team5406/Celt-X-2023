...
public class AlignWithNode extends PIDCommand {
   ...
   */
  public AlignWithNode(SwerveSubsystem swerve, LimelightSubsystem limelight, DoubleSupplier vX, DoubleSupplier vY, LIMELIGHT_PIPELINE pipeline) {
    ...
    super(
        ...
        output -> swerve.drive(new Translation2d(vX.getAsDouble(), vY.getAsDouble()), MathUtil.clamp(output+Math.signum(output)*0.1, -5, 5), true, false),
        // Require the drive
        swerve, limelight);
