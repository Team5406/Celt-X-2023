 ...
 */
public class ScoreGamepieceL2 extends SequentialCommandGroup
{

  public ScoreGamepieceL2(ShoulderSubsystem shoulder, ExtendSubsystem extend, WristSubsystem wrist, IntakeSubsystem intake)
  {
    addCommands(
     ...
     new ParallelCommandGroup(
      ...
      new ConditionalCommand(
        new ParallelDeadlineGroup(
          //new WaitCommand(0.4),
          new MoveWristTrapezoidRelative(0, wrist, shoulder, Constants.WRIST_EXTEND_FAST_ACCELERATION)
        ),
        new WaitCommand(0),
