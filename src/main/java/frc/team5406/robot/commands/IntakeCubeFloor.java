 ...
 */
public class IntakeCubeFloor extends ParallelCommandGroup
{

  public IntakeCubeFloor(ShoulderSubsystem shoulder, ExtendSubsystem extend, WristSubsystem wrist, IntakeSubsystem intake)
  {
    addCommands(
      new MoveShoulderTrapezoid(1, extend, shoulder),
      new MoveWristTrapezoid(Constants.WRIST_CUBE_POSITION, wrist, shoulder, Constants.WRIST_EXTEND_FAST_ACCELERATION),
