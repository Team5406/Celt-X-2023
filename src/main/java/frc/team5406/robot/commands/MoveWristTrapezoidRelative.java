...
public class MoveWristTrapezoidRelative extends ProfiledPIDCommand {
    ...
    * Default speed
    */
  public MoveWristTrapezoidRelative(double position, WristSubsystem wrist, ShoulderSubsystem shoulder) {
    super(
        ...
        () -> wrist.getWristAbsoluteEncoderPosition() + position,
  ...
  public MoveWristTrapezoidRelative(double position, WristSubsystem wrist, ShoulderSubsystem shoulder, double acceleration) {
    super(
        new ProfiledPIDController(
            Constants.WRIST_PID_PROFILED_P,
            Constants.WRIST_PID_PROFILED_I,
