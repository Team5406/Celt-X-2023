 ...
 */
public class OuttakeConeTeleop extends ParallelCommandGroup
{

  public OuttakeConeTeleop(ShoulderSubsystem shoulder, ExtendSubsystem extend, WristSubsystem wrist, IntakeSubsystem intake)
  {
    addCommands(
