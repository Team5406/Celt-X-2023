 ...
 */
public class OuttakeCubeTeleop extends ParallelCommandGroup
{

  public OuttakeCubeTeleop(ShoulderSubsystem shoulder, ExtendSubsystem extend, WristSubsystem wrist, IntakeSubsystem intake)
  {
    addCommands(
